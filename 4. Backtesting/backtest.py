...
if __name__ == "__main__":
    ...
    Y = pd.read_csv(r"E:\\learning\\PaperWorkSpace\\Models\\4. Backtesting\\return.txt",
                    index_col=0, parse_dates=True)
    X = pd.read_csv(r"E:\\learning\\PaperWorkSpace\\Models\\4. Backtesting\\covar.txt",
                    index_col=0, parse_dates=True)

    bt = Backtest(actual=Y.iloc[:, 0],forecast=X.loc[:, "VaR1D"], alpha=0.05)
    print(bt.lr_bt())
    print('===================')
    print(bt.dq_bt())
    bt.plot()
